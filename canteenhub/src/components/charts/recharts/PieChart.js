    ...
    <Card>
      ...
      <CardBody>
        ...
        <div className="d-flex align-items-center justify-content-center flex-wrap">
          <div className="mr-2">
            <span className="bullet bullet-sm bullet-bordered mr-50" style={{ backgroundColor: '#ffe700' }} />
            <span className="align-middle mr-75">Operational</span>
          </div>
          <div className="mr-2">
            <span className="bullet bullet-sm bullet-bordered mr-50" style={{ backgroundColor: '#ffa1a1' }} />
          ...
          <div>
            <span className="bullet bullet-sm bullet-bordered mr-50" style={{ backgroundColor: '#00d4bd' }} />
