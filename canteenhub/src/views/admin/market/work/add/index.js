...
import { addMarketWork } from '@store/actions/market.actions';
...
const MarketWorkAdd = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await dispatch(addMarketWork(data));
                    ...
                    <Col md="12" sm="12" lg="12">
                      ...
                      <FormGroup>
                        ...
                        {Object.keys(errors).length && errors.workLogo ? (
                          <small className="text-danger mt-1">You must drop the work Logo</small>
                        ) : null}
                      </FormGroup>
                    </Col>
                  </Row>
