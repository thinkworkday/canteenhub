...
import { addMarketPartner } from '@store/actions/market.actions';
...
const MarketPartnerAdd = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await dispatch(addMarketPartner(data));

      toast.success(
        <>
          <CheckCircle className="mr-1 text-success" />
          Market Partner added
        </>, {
          position: 'top-right',
          autoClose: 2000,
                  ...
                  <Row>
                    <Col md="12" sm="12" lg="12">
                      ...
                      <FormGroup>
                        ...
                        <Input
                          type="url"
                          placeholder="http://canteenhub.com"
                          id="link"
                          name="link"
                      ...
                      <FormGroup>
                        ...
                        {Object.keys(errors).length && errors.partnerLogo ? (
                          <small className="text-danger mt-1">You must drop the partner Logo</small>
                        ) : null}
                      </FormGroup>
                    </Col>
                  </Row>
...
export default MarketPartnerAdd;
