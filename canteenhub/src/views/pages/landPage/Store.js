...
import {
  getMarketSiteSchools, getMarketSiteStoreContent, getMarketSiteProvides, getMarketSiteWork, getMarketSitePartners, getMarketSiteFeedbacks,
...
const StorePage = () => {
  ...
  const marketSiteStoreContent = useSelector((state) => state.marketSiteStoreContent);
  ...
  const [pageType, setPageType] = useState('store');
  ...
  useEffect(() => {
    dispatch(getMarketSiteStoreContent(dispatchParams));
  }, [dispatch]);
  useEffect(() => {
  ...
  return (
    <>
      {marketSiteStoreContent.loading ? <div className="land-content"><Spinner /></div> : (
            ...
            <div className="land-start page-header-background">
              <div className="container px-3 py-2">
                <Row>
                  <Col md="6" lg="5" sm="12" className="pt-1">
                    <div className="mt-2">
                      <h3 className="land-header-title">
                        {marketSiteStoreContent.data?.title ? marketSiteStoreContent.data.title : ''}
                      </h3>
                      <h3 className="land-header-title">
                        {marketSiteStoreContent.data?.subTitle ? marketSiteStoreContent.data.subTitle : ''}
                      </h3>
                    </div>
                    <div className="mb-2">
                      <span className="land-header-content">
                        {marketSiteStoreContent.data?.content ? marketSiteStoreContent.data.content : ''}
                      </span>
                    </div>
                    <div className="my-3">
                  ...
                  <Col md="6" lg="7" sm="12">
                    <div className="p-1">
                      <img className="img-fluid" src={marketSiteStoreContent.data?.contentLogo ? marketSiteStoreContent.data?.contentLogo : backgroundImg} alt="background" />
                    </div>
                  </Col>
                </Row>
