...
import {
  getMarketSiteSchools, getMarketSiteLandContent, getMarketSiteProvides, getMarketSiteWork, getMarketSitePartners, getMarketSiteFeedbacks,
...
const LandPage = () => {
  ...
  const marketSiteLandContent = useSelector((state) => state.marketSiteLandContent);
  ...
  const [pageType, setPageType] = useState('land');
  ...
  useEffect(() => {
    dispatch(getMarketSiteLandContent(dispatchParams));
  }, [dispatch]);
  useEffect(() => {
  ...
  return (
    <>
      {marketSiteLandContent.loading ? <div className="land-content"><Spinner /></div> : (
            ...
            <div className="land-start page-header-background">
              <div className="container px-3 py-2">
                <Row>
                  <Col md="6" lg="5" sm="12" className="pt-1">
                    <div className="mt-2">
                      <h3 className="land-header-title">
                        {marketSiteLandContent.data?.title ? marketSiteLandContent.data.title : ''}
                      </h3>
                      <h3 className="land-header-title">
                        {marketSiteLandContent.data?.subTitle ? marketSiteLandContent.data.subTitle : ''}
                      </h3>
                    </div>
                    <div className="mb-2">
                      <span className="land-header-content">
                        {marketSiteLandContent.data?.content ? marketSiteLandContent.data.content : ''}
                      </span>
                    </div>
                    <div className="my-3">
                  ...
                  <Col md="6" lg="7" sm="12">
                    <div className="p-1">
                      <img className="img-fluid" src={marketSiteLandContent.data?.contentLogo ? marketSiteLandContent.data?.contentLogo : backgroundImg} alt="background" />
                    </div>
                  </Col>
                </Row>
