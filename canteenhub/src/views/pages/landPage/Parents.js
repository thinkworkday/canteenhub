...
import {
  getMarketSiteSchools, getMarketSiteParentContent, getMarketSiteProvides, getMarketSiteWork, getMarketSitePartners, getMarketSiteFeedbacks,
...
const ParentPage = () => {
  ...
  const marketSiteParentContent = useSelector((state) => state.marketSiteParentContent);
  ...
  const [pageType, setPageType] = useState('parents');
  ...
  useEffect(() => {
    dispatch(getMarketSiteParentContent(dispatchParams));
  }, [dispatch]);
  useEffect(() => {
    dispatch(getMarketSiteSchools());
    dispatch(getMarketSiteProvides());
  }, [marketSiteSchools.data.length]);
  useEffect(() => {
  ...
  return (
    <>
      {marketSiteParentContent.loading ? <div className="land-content"><Spinner /></div> : (
            ...
            <div className="land-start page-header-background">
              <div className="container px-3 py-2">
                <Row>
                  <Col md="6" lg="5" sm="12" className="pt-1">
                    <div className="mt-2">
                      <h3 className="land-header-title">
                        {marketSiteParentContent.data?.title ? marketSiteParentContent.data.title : ''}
                      </h3>
                      <h3 className="land-header-title">
                        {marketSiteParentContent.data?.subTitle ? marketSiteParentContent.data.subTitle : ''}
                      </h3>
                    </div>
                    <div className="mb-2">
                      <span className="land-header-content">
                        {marketSiteParentContent.data?.content ? marketSiteParentContent.data.content : ''}
                      </span>
                    </div>
                    <div className="my-3">
                  ...
                  <Col md="6" lg="7" sm="12">
                    <div className="p-1">
                      <img className="img-fluid" src={marketSiteParentContent.data?.contentLogo ? marketSiteParentContent.data?.contentLogo : backgroundImg} alt="background" />
                    </div>
                  </Col>
                </Row>
